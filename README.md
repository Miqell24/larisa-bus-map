# Larisa Public Transport — interactive map

Interactive, poster-grade map of the public transport network of **Larisa**:
the 18 bus lines of Αστικό ΚΤΕΛ Λάρισας Α.Ε. drawn on the real roadway, one stroke
...
**Larisa publishes no GTFS anywhere.** The operator's site carries timetables and
...
passenger site, `larisa.citybus.gr`, one tenant of the citybus.gr platform that
...
npm run serve      # http://localhost:8179
```
