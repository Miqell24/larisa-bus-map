...
Larisa: 2 x 2 road tiles over the 28 x 22 km the network actually covers
(Giannouli, Falani and Dasochori north, Terpsithea south-west, Nikaia south, Omorfochori east and the VIPE industrial estate 16 km out on the Sykourio road). No rail file: Larisa has no tram and no metro.
...
# must match pipeline/download.sh — the stop cloud is 39.5601..39.7721 N, 22.2904..22.5015 E;
# this adds ~2 km of margin so a route never runs off the graph at the edge
S, N, W, E = 39.540, 39.793, 22.264, 22.527
