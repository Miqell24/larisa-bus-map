...
// own passenger site at larisa.citybus.gr — the citybus.gr platform that several Greek
...
const HOST = 'larisa.citybus.gr';
const API = 'https://rest.citybus.gr/api/v1';
const AGENCY_ID = 'ASTIKO_LARISAS';
const AGENCY_NAME = 'Αστικό ΚΤΕΛ Λάρισας Α.Ε.';
const AGENCY_URL = 'https://ktelast-larisas.gr';
