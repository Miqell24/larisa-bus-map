...
// Larisa: ONE feed, and this map builds it itself — see pipeline/citybus-feed.mjs.
// 18 bus lines of Αστικό ΚΤΕΛ Λάρισας in the family's navy. No trolleybus, no tram,
...
const NAME_FIX = {
  'FASHION CITY OUTLET': 'Fashion City Outlet',
  'CAFFE BRUNO (ΒΙΠΕ)': 'Caffe Bruno (ΒΙΠΕ)',
};
